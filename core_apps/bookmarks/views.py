    ...
    def perform_create(self, serializer):
        ...
        if article_id:
            try:
                ...
                raise ValidationError("Invalid article_id is provided")
        else:
            raise ValidationError("article_id is required")
        try:
            serializer.save(user=self.request.user, article=article)
        except IntegrityError:
            raise ValidationError("You have already bookmarked this page")
...
class BookmarkDestroyView(generics.DestroyAPIView):
    ...
    def get_object(self):
        ...
        try:
            ...
            raise NotFound("Bookmark not found or it doesnt belong to you")
