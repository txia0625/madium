...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name = _('phone number'), max_length=30, default="+1 12345678")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=180, default="Madison", blank=False, null=False)
